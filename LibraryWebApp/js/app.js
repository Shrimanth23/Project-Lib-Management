...
async function getBooksByGenre() {
    ...
    try {
		...
		listItem.innerHTML = `
   			 ${book.title || "Title not found"} by ${book.author || "Author not found"}
    			<button onclick="deleteBook(${book.book_id || book.BookId})">Delete</button>
			`;
...
// Function to delete a book by book_id from the input field
async function deleteBookByIdInput() {
